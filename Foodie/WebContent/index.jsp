...
<body>
  ...
  <a class="rest-link" href="allrestaurants" onclick="showLoading()">All Restaurants</a>
  ...
  <div class="restaurants">
    ...
    %>
      <div class="rest-menu" style="display: <%= index < 10 ? "block" : "none" %>;">
        ...
        <a class="view-menu" href="showMenu?resturantId=<%= rest.getRestaurantid() %>&restName=<%=rest.getResName()%>">View Menu</a>
